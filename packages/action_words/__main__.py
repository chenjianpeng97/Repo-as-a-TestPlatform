...
用法::
    ...
    uv run python -m packages.action_words describe db_seed.create_example
    uv run python -m packages.action_words run db_seed.create_example --params "{...}"
    uv run python -m packages.action_words run db_seed.create_example --params-file p.json
    uv run python -m packages.action_words run db_seed.create_example --example
...
from packages.action_words import ActionContext, export_catalog, get, list_all
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(prog="python -m packages.action_words")
