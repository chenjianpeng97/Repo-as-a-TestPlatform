...
from packages.fake.catalog import EmptyInputs, register
from packages.fake.core import get_faker
...
def __getattr__(name: str):
    """Keep ``from packages.fake.wrappers import person_name`` working for loop-bound names."""
    if name in globals():
        return globals()[name]
