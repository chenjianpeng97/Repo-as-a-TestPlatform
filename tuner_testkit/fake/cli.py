"""tuner_testkit.fake CLI — list / describe / run / catalog.
...
from tuner_testkit.fake.catalog import catalog, describe, get, run
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(prog="python -m tuner_testkit.fake")
