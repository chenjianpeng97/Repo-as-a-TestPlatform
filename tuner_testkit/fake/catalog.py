...
def discover() -> None:
    ...
    if _discovered:
        return
    _discovered = True
    from tuner_testkit.fake import china as _china  # noqa: F401
    from tuner_testkit.fake import core as _core  # noqa: F401
    from tuner_testkit.fake import medical as _medical  # noqa: F401
    from tuner_testkit.fake import wrappers as _wrappers  # noqa: F401
...
def run(
    ...
    *,
    ...
    if req.seed is not None:
        from tuner_testkit.fake.core import seed as seed_rng
