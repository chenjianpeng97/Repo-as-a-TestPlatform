...
from tuner_testkit.page_test.session import MAIN_BLOCK_TEMPLATE
...
from tuner_testkit.page_test.steps import Step
...
def render_page_model_source(
    ...
    *,
    ...
    import_block = "from tuner_testkit.page_test import (\n    " + ",\n    ".join(imports) + ",\n)"
