...
if __name__ == "__main__":
    ...
    # Auth: tuner_testkit.api_objects.auth (Postman/Apifox-style shared credentials).
    ...
    from tuner_testkit.api_objects.auth import (
...
def render_api_model_source(
    *,
    ...
    desc_lines = [
        ...
        "  - ``__main__`` 回放样本见文末；鉴权见 tuner_testkit.api_objects.auth",
