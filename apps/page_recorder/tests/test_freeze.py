...
from apps.page_recorder.capture import build_capture
from apps.page_recorder.codegen import render_page_model_source
from apps.page_recorder.freeze import (
    PageObjectFreezer,
    collapse_steps,
    load_existing_model,
)
...
from packages.page_test.steps import Click, Fill, WaitForElement
...
def test_freeze_creates_pagemodel_with_main_block(tmp_path: Path):
    ...
    assert "packages.page_objects.session" in text
