...
from apps.page_recorder.cli import build_parser, main
from apps.page_recorder.session import resolve_start_url
...
def test_resolve_start_url_joins_relative(monkeypatch):
    monkeypatch.setattr(
        "packages.config.get_ui_base_url",
