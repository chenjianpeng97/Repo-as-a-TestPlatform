...
| 名称 | 触发 | 作用范围 | 版本 | 职责 | 文件 |
| --- | --- | --- | --- | --- | --- |
| `apps-authoring` | glob | apps/** | 1.2.1 | apps/ tools must be standalone-runnable and reuse packages (db/logging/config/api) | `.cursor/rules/apps-authoring.mdc` |
...
| `maintain-page-objects` | on-demand | - | 2.0.1 | Creates or updates page assets under packages/page_objects/ on the packages.page_test runtime (PageModel element table … | `.cursor/skills/maintain-page-objects/SKILL.md` |
